import { Command, App } from '@disploy/framework';
...
var hey = /*#__PURE__*/ function(Command) {
    _inherits$1(hey, Command);
    var _super = _createSuper$1(hey);
    function hey() {
        _classCallCheck$1(this, hey);
        return _super.call(this, {
            name: "hey",
            description: "heyy!"
        });
    }
    var _proto = hey.prototype;
    _proto.slashRun = function slashRun(interaction) {
...
var ping = /*#__PURE__*/ function(Command) {
    _inherits(ping, Command);
...
export { _virtual_entry as default };
